...
======================
copy from: https://github.com/grpc/grpc-go/tree/master/examples
...
```
$ go get -u github.com/wongoo/grpc/grpc-golang/helloworld/greeter_client
$ go get -u github.com/wongoo/grpc/grpc-golang/helloworld/greeter_server
```
...
1. Rebuild the generated Go code
   ...
   ```
   $ go generate github.com/wongoo/grpc/grpc-golang/helloworld/...
   ```
